...
(function (e) {
    ...
    }, itemsByValue: function (t, n) {
        if (!n || t === null)return[];
        e.isArray(t) || (t = [t]);
        var r = e.grep(n, function (n) {
    ...
    t.prototype = {containerName: null, innerCss: null, init: function (n, r) {
        this.$element = e(n), this.options = e.extend({}, e.fn.editableContainer.defaults, e.fn.editableutils.getConfigData(this.$element), r), this.splitOptions(), this.formOptions.scope = this.$element[0], this.initContainer(), this.$element.on("destroyed", e.proxy(function () {
            this.destroy()
    ...
    e.extend(e.fn.editableContainer.Inline.prototype, e.fn.editableContainer.Popup.prototype, {containerName: "editableform", innerCss: ".editable-inline", initContainer: function () {
        ...
        this.$tip.hide(this.options.anim, e.proxy(function () {
            this.$element.show(), this.tip().empty().remove()
        }, this))
    }, innerDestroy: function () {
        this.tip().remove()
    }})
    ...
    t.prototype = {constructor: t, init: function () {
        ...
        return this.input.options.hasOwnProperty("source") ? this.input.value2html(this.value, this.$element[0], this.options.display, e) : typeof this.options.display == "function" ? this.options.display.call(this.$element[0], this.value, e) : this.input.value2html(this.value, this.$element[0])
    }, enable: function () {
        ...
        typeof this.options.url != "function" && this.options.display !== !1 && t.response === undefined && this.input.value2str(this.value) !== this.input.value2str(t.newValue) ? this.$element.addClass("editable-unsaved") : this.$element.removeClass("editable-unsaved"), this.setValue(t.newValue, !1, t.response)
    }, validate: function () {
    ...
    e.fn.editableutils.inherit(t, e.fn.editabletypes.abstractinput), e.extend(t.prototype, {render: function () {
        ...
        } else typeof this.options.source == "function" ? this.sourceData = this.makeArray(this.options.source()) : this.sourceData = this.makeArray(this.options.source), e.isArray(this.sourceData) ? (this.doPrepend(), t.call(this)) : n.call(this)
    }, doPrepend: function () {
    ...
    e.fn.editableutils.inherit(t, e.fn.editabletypes.abstractinput), e.extend(t.prototype, {render: function () {
        ...
        this.options.clear && (this.$clear = e('<span class="editable-clear-x"></span>'), this.$input.after(this.$clear).css("padding-right", 20).keyup(e.proxy(this.toggleClear, this)).parent().css("position", "relative"), this.$clear.click(e.proxy(function () {
        ...
        this.$input.val() ? this.$clear.show() : this.$clear.hide()
    ...
    e.fn.editableutils.inherit(t, e.fn.editabletypes.list), e.extend(t.prototype, {renderList: function () {
        ...
        this.setClass(), this.$input.on("keydown.editable", function (t) {
    ...
    e.fn.editableutils.inherit(t, e.fn.editabletypes.list), e.extend(t.prototype, {renderList: function () {
        ...
        this.$tpl.empty();
        if (!e.isArray(this.sourceData))return;
        for (var r = 0; r < this.sourceData.length; r++)t = e("<label>").append(e("<input>", {type: "checkbox", value: this.sourceData[r].value, name: this.options.name})).append(e("<span>").text(" " + this.sourceData[r].text)), e("<div>").append(t).appendTo(this.$tpl);
        ...
        this.$input.removeAttr("checked"), e.isArray(t) && t.length && this.$input.each(function (n, r) {
            var i = e(r);
