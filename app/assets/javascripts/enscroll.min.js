...
(function (d, h, o) {
    var e = {getEvent: function (p) {
        ...
        var r = d(this).data("enscroll"), q = this, p = r.settings, t = function () {
            var v = d(this).data("enscroll"), u = v.settings;
            if (v && u.showOnHover) {
        ...
        var r = d(t), s = r.data("enscroll"), q = r.scrollTop();
        ...
        var r = d(t), s = r.data("enscroll"), q = r.scrollLeft();
        ...
        var v = s.data.pane, x = d(v).data("enscroll"), D = true, t, y, p, r, q, w, E, z, A, u = function () {
            if (D) {
                if (p !== r) {
                    d(v).scrollTop(p * A / z);
                    r = p
        ...
        w = d(t).offset().top;
        d(o.body).on({"mousemove.enscroll.vertical": C, "mouseup.enscroll.vertical": function (F) {
            B.call(y, F)
        }});
        ...
        var u = q.data.pane, w = d(u).data("enscroll"), D = true, s, y, p, r, A, v, x, E, z, t = function () {
            if (D) {
                if (p !== r) {
        ...
        x = d(s).offset().left;
        d(o.body).on({"mousemove.enscroll.horizontal": C, "mouseup.enscroll.horizontal": function (F) {
            B.call(y, F)
        }});
        E = d("body").css("cursor");
        ...
        var s = this.data("enscroll"), t, p, u, q;
        if (s) {
            r = e.getEvent(r);
        ...
        var u = d(this), t = u.data("enscroll"), s, p, r;
        if (t) {
        ...
        var t = d(this), q = this, s = t.data("enscroll"), p;
        if (r.target === this && s) {
        ...
        var q, p, r = null, u = function (w) {
            var z = d(this), v = q, x = p, A = z.scrollLeft(), y = z.scrollTop();
            q = w.touches[0].clientX;
            p = w.touches[0].clientY;
            if (r === null) {
                r = Math.abs(x - p) > Math.abs(v - q) ? "y" : "x"
            }
            if (r === "y") {
                i(this, x - p)
            } else {
            ...
            if (y !== z.scrollTop() || A !== z.scrollLeft()) {
                w.preventDefault()
            }
        }, s = function () {
            this.removeEventListener("touchmove", u, false);
            this.removeEventListener("touchend", s, false)
        };
        if (t.touches.length === 1) {
            q = t.touches[0].clientX;
            p = t.touches[0].clientY;
            this.addEventListener("touchmove", u, false);
            this.addEventListener("touchend", s, false)
        }
    }, g = {reposition: function () {
        return this.each(function () {
            var u = d(this), t = u.data("enscroll"), r = function (A, z, B) {
                A.style.left = z + "px";
                A.style.top = B + "px"
            }, x = function (z, B) {
                var y = d(z).css(B), A = /^-?\d+/.exec(y);
                return A ? +A[0] : 0
            }, w, p, s, q, v;
            if (t) {
                s = u.position();
        ...
        return this.each(function () {
            var s = d(this), G = s.data("enscroll"), C, w, F, A, q, z, v, p, B, t, x, r, D, u, y, E;
            if (s.is(":visible") && G) {
                C = G.settings;
        ...
        return this.each(function () {
            var t = d(this).data("enscroll"), s = this, q = d(s), w = -1, r = -1, x = -1, p = -1, v, u = function () {
                if (t.settings.pollChanges) {
                    var y = s.scrollWidth, z = s.scrollHeight, A = q.width(), C = q.height(), B = q.offset();
        ...
        return this.each(function () {
            var r = d(this), q = r.data("enscroll"), p, s;
            if (q) {
        ...
        return this.each(function () {
            ...
            if (p.verticalScrolling) {
                ...
                if (p.drawScrollButtons) {
                    L = o.createElement("a");
                    z = o.createElement("a");
                    d(L).css({display: "block", "text-decoration": "none"}).attr("href", "").html("&nbsp;").addClass(p.scrollUpButtonClass).on("click",function () {
                        i(I, -p.scrollIncrement);
                        return false
                    }).insertBefore(R);
                    d(z).css({display: "block", "text-decoration": "none"}).attr("href", "").html("&nbsp;").on("click",function () {
                        i(I, p.scrollIncrement);
                        return false
                ...
                d(A).css({position: "absolute", "z-index": 1}).attr("href", "").addClass(p.verticalHandleClass).mousedown({pane: this}, n).click(function () {
                    return false
                }).appendTo(R);
                ...
                D = d(R).outerWidth();
                B.css({width: (B.width() - D) + "px", "padding-right": (parseInt(B.css("padding-right"), 10) + D) + "px"});
                try {
            ...
            if (p.horizontalScrolling) {
                ...
                O = o.createElement("a");
                d(G).css({position: "relative", "z-index": 1}).addClass("enscroll-track").addClass(p.horizontalTrackClass).appendTo(M);
                if (p.drawScrollButtons) {
                    F = o.createElement("a");
                    S = o.createElement("a");
                ...
                d(O).css({position: "absolute", "z-index": 1}).attr("href", "").addClass(p.horizontalHandleClass).click(function () {
                    return false
                }).mousedown({pane: this}, a).appendTo(G);
                ...
                t = d(G).outerHeight();
                B.css({height: (B.height() - t) + "px", "padding-bottom": (parseInt(B.css("padding-bottom"), 10) + t) + "px"});
                if (!d.browser.msie || d.browser.msie && d.browser.version > 7) {
                    P = document.createElement("div");
                    d(P).html("&nbsp;").css({height: "1px", visibility: "hidden", padding: 0, margin: "-1px"}).appendTo(this)
                }
            }
            ...
            B.on({"scroll.enscroll.pane": function (V) {
                j.call(this, V)
            }, "keydown.enscroll.pane": f}).css("overflow", "hidden").data("enscroll", {settings: p, horizontalTrackWrapper: M, verticalTrackWrapper: K, corner: C, _prybar: P, _mouseScrollHandler: w, _hadTabIndex: s, _style: J});
