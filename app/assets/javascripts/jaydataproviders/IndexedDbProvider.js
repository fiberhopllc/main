...
$data.IndexedDBConverter = {
    fromDb: {
        ...
        '$data.Blob': function (b) {
            return b ? $data.Container.convertTo(b, $data.Blob) : b;
        },
    ...
    toDb: {
        ...
        '$data.Boolean': $data.Container.proxyConverter,
        '$data.Blob': function (b) {
            return b ? $data.Blob.toString(b) : b;
        },
        '$data.Array': function (arr) {
                    ...
                    var convertedItems = currentBlock.map(function (item) {
                        ...
                        item.entitySet.elementType.memberDefinitions
                            .getPublicMappedProperties().forEach(function (memDef) {
                                ...
                                if (!memDef.inverseProperty && typeof memDef.concurrencyMode === 'undefined' && (memDef.key === true || item.data.entityState === $data.EntityState.Added || (item.data.changedProperties && item.data.changedProperties.some(function (def) {
