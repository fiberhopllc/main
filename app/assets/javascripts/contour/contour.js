        ...
        var arrayHelpers = {
            ...
            normalizeSeries: function (data, categories) {
                ...
                var correctSeriesFormat = _.isArray(data) && _.isObject(data[0]) && data[0].hasOwnProperty('data') &&
                    data[0].hasOwnProperty('name') && _.all(data[0].data, function (p) {
                    return p.hasOwnProperty('x') && p.hasOwnProperty('y');
                });
    ...
    *     });
    ...
    (function () {
        ...
        var _stackedExtent = function (data) {
            ...
            var maxLength = _.max(_.map(dataSets, function (d) {
                return d.length;
            }));
            var stackY = [];
    ...
    (function () {
        ...
        function renderer(data, layer, options) {
            ...
            var area = d3.svg.area()
                ...
                .y0(function (d) {
                    return options.area.stacked ? y(d.y0 || options.yAxis.min || 0) : y(0);
                })
                .y1(function (d) {
    ...
    (function () {
        ...
        function renderer(data, layer, options) {
            ...
            var classFn = function (d, i) {
                return 'series arc' + (options.tooltip.enable ? ' tooltip-tracker' : '') + ' s-' + (i + 1) + ' ' + d.name;
            };
