!function (e) {
    ...
    t.prototype = {constructor: t, setColor: function (t) {
        ...
        e.each(n.stringParsers, function (e, a) {
            var o = a.re.exec(t), r = o && a.parse(o), s = a.space || "rgba";
        ...
        var a, o, r, s, l;
        return e = e % 360 / 60, l = i * t, s = l * (1 - Math.abs(e % 2 - 1)), a = o = r = i - l, e = ~~e, a += [l, s, 0, 0, s, l][e], o += [s, l, l, s, 0, 0][e], r += [0, 0, s, l, l, s][e], {r: Math.round(255 * a), g: Math.round(255 * o), b: Math.round(255 * r), a: n || this.value.a}
    ...
    i.prototype = {constructor: i, show: function (t) {
        ...
        var i = e(t.target), a = i.closest("div");
        if (!a.is(".colorpicker")) {
            if (a.is(".colorpicker-saturation"))this.slider = e.extend({}, n.sliders.saturation); else if (a.is(".colorpicker-hue"))this.slider = e.extend({}, n.sliders.hue); else {
                if (!a.is(".colorpicker-alpha"))return!1;
                this.slider = e.extend({}, n.sliders.alpha)
            }
            var o = a.offset();
            this.slider.knob = a.find("i")[0].style, this.slider.left = t.pageX - o.left, this.slider.top = t.pageY - o.top, this.pointer = {left: t.pageX, top: t.pageY}, e(document).on({mousemove: e.proxy(this.mousemove, this), mouseup: e.proxy(this.mouseup, this)}).trigger("mousemove")
        }
        return!1
    }, mousemove: function (e) {
        e.stopPropagation(), e.preventDefault();
        var t = Math.max(0, Math.min(this.slider.maxLeft, this.slider.left + ((e.pageX || this.pointer.left) - this.pointer.left))), i = Math.max(0, Math.min(this.slider.maxTop, this.slider.top + ((e.pageY || this.pointer.top) - this.pointer.top)));
        return this.slider.knob.left = t + "px", this.slider.knob.top = i + "px", this.slider.callLeft && this.color[this.slider.callLeft].call(this.color, t / 100), this.slider.callTop && this.color[this.slider.callTop].call(this.color, i / 100), this.previewColor(), this.element.trigger({type: "changeColor", color: this.color}), !1
    }, mouseup: function (t) {
        ...
        return this.each(function () {
            var a = e(this), o = a.data("colorpicker"), r = "object" == typeof t && t;
    ...
    var n = {translateFormats: {rgb: function () {
    ...
    }}, sliders: {saturation: {maxLeft: 100, maxTop: 100, callLeft: "setSaturation", callTop: "setLightness"}, hue: {maxLeft: 0, maxTop: 100, callLeft: !1, callTop: "setHue"}, alpha: {maxLeft: 0, maxTop: 100, callLeft: !1, callTop: "setAlpha"}}, RGBtoHSB: function (e, t, i, n) {
        e /= 255, t /= 255, i /= 255;
        var a, o, r, s;
        return r = Math.max(e, t, i), s = r - Math.min(e, t, i), a = 0 === s ? null : r == e ? (t - i) / s : r == t ? (i - e) / s + 2 : (e - t) / s + 4, a = 60 * ((a + 360) % 6) / 360, o = 0 === s ? 0 : s / r, {h: a || 1, s: o, b: r, a: n || 1}
        ...
        var o;
        o = .5 >= i ? i * (1 + t) : i + t - i * t;
        var r = 2 * i - o, s = e + 1 / 3, l = e, c = e - 1 / 3, u = Math.round(255 * n.HueToRGB(r, o, s)), d = Math.round(255 * n.HueToRGB(r, o, l)), h = Math.round(255 * n.HueToRGB(r, o, c));
        return[u, d, h, a || 1]
    }, stringParsers: [
