...
<%
title = "Tech IT Fast | Property Management"
'mainHeight = 1100
strArr = Array("Property Management","Industries/Property-Management.asp","Industries","Industries/","Home","")
%>
...
<div class="content_pad_<%=layout%>">
  ...
  <div class="content_pad_<%=layout%>">
    ...
    <div class="content_pad_<%=layout%>">Coming Soon</div>
  </div>
