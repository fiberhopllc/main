!function (e) {
    ...
    var g = window.MutationObserver || window.WebKitMutationObserver || !1, w = {zindex: "auto", cursoropacitymin: 0, cursoropacitymax: 1, cursorcolor: "rgba(0,0,0,0.7)", cursorwidth: "6px", cursorborder: "", cursorborderradius: "", scrollspeed: 60, mousescrollstep: 24, touchbehavior: !1, hwacceleration: !0, usetransition: !0, boxzoom: !1, dblclickzoom: !0, gesturezoom: !0, grabcursorenabled: !0, autohidemode: !0, background: "", iframeautoresize: !0, cursorminheight: 32, preservenativescrolling: !0, railoffset: !1, bouncescroll: !0, spacebarenabled: !0, railpadding: {top: 0, right: 0, left: 0, bottom: 0}, disableoutline: !0, horizrailenabled: !0, railalign: "right", railvalign: "bottom", enabletranslate3d: !0, enablemousewheel: !0, enablekeyboard: !0, smoothscroll: !0, sensitiverail: !0, enablemouselockapi: !0, cursorfixedheight: !1, directionlockdeadzone: 6, hidecursordelay: 300, nativeparentscrolling: !0, enablescrollonselection: !0, overflowx: !0, overflowy: !0, cursordragspeed: .3, rtlmode: !1, cursordragontouch: !1, oneaxismousemode: "auto"}, v = !1, y = function () {
        ...
        var v = this;
        if (this.version = "3.5.0 BETA5", this.name = "nicescroll", this.me = o, this.opt = {doc: c("body"), win: !1}, c.extend(this.opt, w), this.opt.snapbackspeed = 80, e)for (var b in v.opt)"undefined" != typeof e[b] && (v.opt[b] = e[b]);
        ...
        }}, this.ishwscroll ? (this.doc.translate = {x: 0, y: 0, tx: "0px", ty: "0px"}, S.hastranslate3d && S.isios && this.doc.css("-webkit-backface-visibility", "hidden"), this.getScrollTop = function (e) {
            if (!e) {
                var o = t();
        ...
        this.getOffset = function () {
            ...
            if (v.ishwscroll)v.rail.css({height: v.win.innerHeight()}), v.railh && v.railh.css({width: v.win.innerWidth()}); else {
                ...
                if (r && (r.top && (t.top += r.top), v.rail.align && r.left && (t.left += r.left)), v.locked || v.rail.css({top: t.top, left: t.left, height: e ? e.h : v.win.innerHeight()}), v.zoom && v.zoom.css({top: t.top + 1, left: 1 == v.rail.align ? t.left - 20 : t.left + v.rail.width + 4}), v.railh && !v.locked) {
                    var t = {top: o.top, left: o.left}, i = v.railh.align ? t.top + u(v.win, "border-top-width", !0) + v.win.innerHeight() - v.railh.height : t.top + u(v.win, "border-top-width", !0), n = t.left + u(v.win, "border-left-width");
            ...
            function o() {
                ...
                if (v.forcescreen = !0, v.isiframe && (v.iframe = {doc: c(e), html: v.doc.contents().find("html")[0], body: v.doc.contents().find("body")[0]}, v.getContentSize = function () {
                ...
                v.lazyResize(30), S.isie7 && v.css(c(v.iframe.html), {"overflow-y": "hidden"}), v.css(c(v.iframe.body), {"overflow-y": "hidden"}), S.isios && v.haswrapper && (v.css(c(e.body), {"-webkit-transform": "translate3d(0,0,0)"}), console.log(1)), "contentWindow"in this ? v.bind(this.contentWindow, "scroll", v.onscroll) : v.bind(e, "scroll", v.onscroll), v.opt.enablemousewheel && v.bind(e, "mousewheel", v.onmousewheel), v.opt.enablekeyboard && v.bind(e, S.isopera ? "keypress" : "keydown", v.onkeypress), (S.cantouch || v.opt.touchbehavior) && (v.bind(e, "mousedown", v.ontouchstart), v.bind(e, "mousemove", function (e) {
                    v.ontouchmove(e, !0)
                }), v.opt.grabcursorenabled && S.cursorgrabvalue && v.css(c(e.body), {cursor: S.cursorgrabvalue})), v.bind(e, "mouseup", v.ontouchend), v.zoom && (v.opt.dblclickzoom && v.bind(e, "dblclick", v.doZoom), v.ongesturezoom && v.bind(e, "gestureend", v.ongesturezoom))
            }

            if (v.saved.css = [], S.isie7mobile)return!0;
            if (S.isoperamini)return!0;
            if (S.hasmstouch && v.css(v.ispage ? c("html") : v.win, {"-ms-touch-action": "none"}), v.zindex = "auto", v.zindex = v.ispage || "auto" != v.opt.zindex ? v.opt.zindex : a() || "auto", v.ispage || "auto" == v.zindex || v.zindex > l && (l = v.zindex), v.isie && 0 == v.zindex && "auto" == v.opt.zindex && (v.zindex = "auto"), !v.ispage || !S.cantouch && !S.isieold && !S.isie9mobile) {
                var t = v.docscroll;
                v.ispage && (t = v.haswrapper ? v.win : v.doc), S.isie9mobile || v.css(t, {"overflow-y": "hidden"}), v.ispage && S.isie7 && ("BODY" == v.doc[0].nodeName ? v.css(c("html"), {"overflow-y": "hidden"}) : "HTML" == v.doc[0].nodeName && v.css(c("body"), {"overflow-y": "hidden"})), !S.isios || v.ispage || v.haswrapper || v.css(c("body"), {"-webkit-overflow-scrolling": "touch"});
                ...
                u.append(s), u.width = Math.max(parseFloat(v.opt.cursorwidth), s.outerWidth()) + v.opt.railpadding.left + v.opt.railpadding.right, u.css({width: u.width + "px", zIndex: v.zindex, background: v.opt.background, cursor: "default"}), u.visibility = !0, u.scrollable = !0, u.align = "left" == v.opt.railalign ? 0 : 1, v.rail = u, v.rail.drag = !1;
                var w = !1;
                if (!v.opt.boxzoom || v.ispage || S.isieold || (w = document.createElement("div"), v.bind(w, "click", v.doZoom), v.zoom = c(w), v.zoom.css({cursor: "pointer", "z-index": v.zindex, backgroundImage: "url(" + d + "zoomico.png)", height: 18, width: 18, backgroundPosition: "0px 0px"}), v.opt.dblclickzoom && v.bind(v.win, "dblclick", v.doZoom), S.cantouch && v.opt.gesturezoom && (v.ongesturezoom = function (e) {
                    ...
                    var s = c(document.createElement("div"));
                    s.css({position: "relative", top: 0, height: v.opt.cursorwidth, width: "0px", "background-color": v.opt.cursorcolor, border: v.opt.cursorborder, "background-clip": "padding-box", "-webkit-border-radius": v.opt.cursorborderradius, "-moz-border-radius": v.opt.cursorborderradius, "border-radius": v.opt.cursorborderradius}), s.wborder = parseFloat(s.outerWidth() - s.innerWidth()), v.cursorh = s;
                    var y = c(document.createElement("div"));
                    y.attr("id", v.id + "-hr"), y.addClass("nicescroll-rails"), y.height = Math.max(parseFloat(v.opt.cursorwidth), s.outerHeight()), y.css({height: y.height + "px", zIndex: v.zindex, background: v.opt.background}), y.append(s), y.visibility = !0, y.scrollable = !0, y.align = "top" == v.opt.railvalign ? 0 : 1, v.railh = y, v.railh.drag = !1
                }
                if (v.ispage)u.css({position: "fixed", top: "0px", height: "100%"}), u.css(u.align ? {right: "0px"} : {left: "0px"}), v.body.append(u), v.railh && (y.css({position: "fixed", left: "0px", width: "100%"}), y.css(y.align ? {bottom: "0px"} : {top: "0px"}), v.body.append(y)); else {
                    if (v.ishwscroll) {
                        "static" == v.win.css("position") && v.css(v.win, {position: "relative"});
                        var b = "HTML" == v.win[0].nodeName ? v.body : v.win;
                        v.zoom && (v.zoom.css({position: "absolute", top: 1, right: 0, "margin-right": u.width + 4}), b.append(v.zoom)), u.css({position: "absolute", top: 0}), u.css(u.align ? {right: 0} : {left: 0}), b.append(u), y && (y.css({position: "absolute", left: 0, bottom: 0}), y.css(y.align ? {bottom: 0} : {top: 0}), b.append(y))
                    } else {
                        v.isfixed = "fixed" == v.win.css("position");
                        var z = v.isfixed ? "fixed" : "absolute";
                        v.isfixed || (v.viewport = v.getViewport(v.win[0])), v.viewport && (v.body = v.viewport, 0 == /relative|absolute/.test(v.viewport.css("position")) && v.css(v.viewport, {position: "relative"})), u.css({position: z}), v.zoom && v.zoom.css({position: z}), v.updateScrollBar(), v.body.append(u), v.zoom && v.body.append(v.zoom), v.railh && (y.css({position: z}), v.body.append(y))
                    }
                    S.isios && v.css(v.win, {"-webkit-tap-highlight-color": "rgba(0,0,0,0)", "-webkit-touch-callout": "none"}), S.isie && v.opt.disableoutline && v.win.attr("hideFocus", "true"), S.iswebkit && v.opt.disableoutline && v.win.css({outline: "none"})
                }
                if (v.opt.autohidemode === !1 ? (v.autohidedom = !1, v.rail.css({opacity: v.opt.cursoropacitymax}), v.railh && v.railh.css({opacity: v.opt.cursoropacitymax})) : v.opt.autohidemode === !0 ? (v.autohidedom = c().add(v.rail), S.isie8 && (v.autohidedom = v.autohidedom.add(v.cursor)), v.railh && (v.autohidedom = v.autohidedom.add(v.railh)), v.railh && S.isie8 && (v.autohidedom = v.autohidedom.add(v.cursorh))) : "scroll" == v.opt.autohidemode ? (v.autohidedom = c().add(v.rail), v.railh && (v.autohidedom = v.autohidedom.add(v.railh))) : "cursor" == v.opt.autohidemode ? (v.autohidedom = c().add(v.cursor), v.railh && (v.autohidedom = v.autohidedom.add(v.cursorh))) : "hidden" == v.opt.autohidemode && (v.autohidedom = !1, v.hide(), v.locked = !1), S.isie9mobile) {
                    ...
                    var T = v.getScrollTop(), k = v.getScrollLeft();
                    v.mangotouch = {sy: T, ly: T, dry: 0, sx: k, lx: k, drx: 0, lazy: !1, tm: 0}, v.bind(v.docscroll, "scroll", v.onmangotouch)
                } else {
                    if (S.cantouch || v.istouchcapable || v.opt.touchbehavior || S.hasmstouch) {
                        v.scrollmom = new x(v), v.ontouchstart = function (e) {
                            ...
                            if (!v.locked) {
                                ...
                                if (v.rail.drag = {x: e.clientX, y: e.clientY, sx: v.scroll.x, sy: v.scroll.y, st: v.getScrollTop(), sl: v.getScrollLeft(), pt: 2, dl: !1}, v.ispage || !v.opt.directionlockdeadzone)v.rail.drag.dl = "f"; else {
                                    var n = {w: c(window).width(), h: c(window).height()}, s = {w: Math.max(document.body.scrollWidth, document.documentElement.scrollWidth), h: Math.max(document.body.scrollHeight, document.documentElement.scrollHeight)}, l = Math.max(0, s.h - n.h), a = Math.max(0, s.w - n.w);
                                ...
                                if (v.hasmoving = !1, v.lastmouseup = !1, v.scrollmom.reset(e.clientX, e.clientY), !S.cantouch && !this.istouchcapable && !S.hasmstouch) {
                                    ...
                                    /SUBMIT|CANCEL|BUTTON/i.test(c(o).attr("type")) && (pc = {tg: o, click: !1}, v.preventclick = pc)
                                }
                            }
                        ...
                        v.ontouchmove = function (e, o) {
                            ...
                            if (v.rail.drag && 2 == v.rail.drag.pt) {
                                ...
                                var s = e.clientY + ofy, l = s - v.rail.drag.y, a = e.clientX + i, d = a - v.rail.drag.x, u = v.rail.drag.st - l;
                    ...
                    v.onmousedown = function (e, o) {
                        if (!v.rail.drag || 1 == v.rail.drag.pt) {
                            ...
                            var t = v.getTarget(e);
                            return!v.ispage && S.hasmousecapture && t.setCapture(), v.isiframe && !S.hasmousecapture && (v.saved.csspointerevents = v.doc.css("pointer-events"), v.css(v.doc, {"pointer-events": "none"})), v.cancelEvent(e)
                        }
                    ...
                    }, v.opt.grabcursorenabled && S.cursorgrabvalue && (v.css(v.ispage ? v.doc : v.win, {cursor: S.cursorgrabvalue}), v.css(v.rail, {cursor: S.cursorgrabvalue}))) : (v.hasTextSelected = "getSelection"in document ? function () {
                    ...
                    }), S.hasmstouch && (v.css(v.rail, {"-ms-touch-action": "none"}), v.css(v.cursor, {"-ms-touch-action": "none"}), v.bind(v.win, "MSPointerDown", v.ontouchstart), v.bind(document, "MSPointerUp", v.ontouchend), v.bind(document, "MSPointerMove", v.ontouchmove), v.bind(v.cursor, "MSGestureHold", function (e) {
                        e.preventDefault()
                    ...
                    })), (v.opt.cursordragontouch || !S.cantouch && !v.opt.touchbehavior) && (v.rail.css({cursor: "default"}), v.railh && v.railh.css({cursor: "default"}), v.jqbind(v.rail, "mouseenter", function () {
                        ...
                        v.rail.active = !1, v.rail.drag || v.hideCursor()
                    }))), v.opt.enablemousewheel && (v.isiframe || v.bind(S.isie && v.ispage ? document : v.win, "mousewheel", v.onmousewheel), v.bind(v.rail, "mousewheel", v.onmousewheel), v.railh && v.bind(v.railh, "mousewheel", v.onmousewheelhr)), v.ispage || S.cantouch || /HTML|BODY/.test(v.win[0].nodeName) || (v.win.attr("tabindex") || v.win.attr({tabindex: n++}), v.jqbind(v.win, "focus", function (e) {
                ...
                if (v.onkeypress = function (e) {
                    ...
                    var E = v.win.attr("style"), L = parseFloat(v.win.css("width")) + 1;
                ...
                }), v.observer.observe(v.win[0], {childList: !0, characterData: !1, attributes: !0, subtree: !1}), v.observerremover = new g(function (e) {
                    e.forEach(function (e) {
                        if (e.removedNodes.length > 0)for (var o in e.removedNodes)if (e.removedNodes[o] == v.win[0])return v.remove()
                    })
                }), v.observerremover.observe(v.win[0].parentNode, {childList: !0, characterData: !1, attributes: !1, subtree: !1})) : (v.bind(v.win, S.isie && !S.isie9 ? "propertychange" : "DOMAttrModified", v.onAttributeChange), S.isie9 && v.win[0].attachEvent("onpropertychange", v.onAttributeChange), v.bind(v.win, "DOMNodeRemoved", function (e) {
            ...
            v.cursortimeout && (clearTimeout(v.cursortimeout), v.cursortimeout = 0), v.rail && (v.autohidedom && (v.autohidedom.stop().css({opacity: v.opt.cursoropacitymax}), v.cursoractive = !0), v.rail.drag && 1 == v.rail.drag.pt || ("undefined" != typeof e && e !== !1 && (v.scroll.y = Math.round(1 * e / v.scrollratio.y)), "undefined" != typeof o && (v.scroll.x = Math.round(1 * o / v.scrollratio.x))), v.cursor.css({height: v.cursorheight, top: v.scroll.y}), v.cursorh && (v.cursorh.css(!v.rail.align && v.rail.visibility ? {width: v.cursorwidth, left: v.scroll.x + v.rail.width} : {width: v.cursorwidth, left: v.scroll.x}), v.cursoractive = !0), v.zoom && v.zoom.stop().css({opacity: v.opt.cursoropacitymax}))
            ...
            var t = o ? e > 20 ? e : 0 : v.getTransitionSpeed(e), r = t ? S.prefixstyle + "transform " + t + "ms ease-out" : "";
            ...
            if (v.onscrollend && v.scrollrunning) {
                var t = {type: "scrollend", current: {x: o, y: e}, end: {x: v.newscrollx, y: v.newscrolly}};
            ...
            function r() {
                ...
                if (2 == e) {
                    if (v.timer = 0, v.cursorfreezed = !1, v.bzscroll = !1, v.scrollrunning = !1, 0 > o ? o = 0 : o > v.page.maxh && (o = v.page.maxh), 0 > i ? i = 0 : i > v.page.maxw && (i = v.page.maxw), i != v.newscrollx || o != v.newscrolly)v.doScrollPos(i, o); else if (v.onscrollend) {
                        var n = {type: "scrollend", current: {x: sx, y: sy}, end: {x: v.newscrollx, y: v.newscrolly}};
            ...
            if (t && 1 >= t && (c *= t), v.bzscroll = c > 0 ? v.bzscroll ? v.bzscroll.update(a, c) : new BezierClass(l, a, c, 0, 1, 0, 1) : !1, !v.timer) {
                ...
                if (v.cancelAnimationFrame = !1, v.timer = 1, v.onscrollstart && !v.scrollrunning) {
                    var u = {type: "scrollstart", current: {x: n, y: i}, request: {x: e, y: o}, end: {x: v.newscrollx, y: v.newscrolly}, speed: c};
            ...
            if (!v.zoomactive) {
                ...
                v.zoomrestore.style.width = v.win.css("width"), v.zoomrestore.style.height = v.win.css("height"), v.zoomrestore.padding = {w: v.win.outerWidth() - v.win.width(), h: v.win.outerHeight() - v.win.height()}, S.isios4 && (v.zoomrestore.scrollTop = c(window).scrollTop(), c(window).scrollTop(0)), v.win.css({position: S.isios4 ? "absolute" : "fixed", top: 0, left: 0, "z-index": l + 100, margin: "0px"});
            ...
            return v.zoomactive ? (v.zoomactive = !1, v.win.css("margin", ""), v.win.css(v.zoomrestore.style), S.isios4 && c(window).scrollTop(v.zoomrestore.scrollTop), v.rail.css({"z-index": v.zindex}), v.zoom.css({"z-index": v.zindex}), v.zoomrestore = !1, v.zoom.css("backgroundPosition", "0px 0px"), v.onResize(), v.onzoomout && v.onzoomout.call(v), v.cancelEvent(e)) : void 0
        }, this.doZoom = function (e) {
            return v.zoomactive ? v.doZoomOut(e) : v.doZoomIn(e)
        }, this.resizeZoom = function () {
            if (v.zoomactive) {
                var e = v.getScrollTop();
                v.win.css({width: c(window).width() - v.zoomrestore.padding.w + "px", height: c(window).height() - v.zoomrestore.padding.h + "px"}), v.onResize(), v.setScrollTop(Math.min(v.page.maxh, e))
            }
    ...
    c.cssHooks.pageXOffset = {get: function (e) {
        var o = c.data(e, "__nicescroll") || !1;
