!function (t) {
    ...
    "function" != typeof Array.prototype.reduce && (Array.prototype.reduce = function (t, e) {
        var n, a, o = this.length >>> 0, i = !1;
        for (1 < arguments.length && (a = e, i = !0), n = 0; o > n; ++n)this.hasOwnProperty(n) && (i ? a = t(a, this[n], n, this) : (a = this[n], i = !0));
        if (!i)throw new TypeError("Reduce of empty array with no initial value");
        return a
    });
    var n = {bMac: navigator.appVersion.indexOf("Mac") > -1, bMSIE: navigator.userAgent.indexOf("MSIE") > -1, bFF: navigator.userAgent.indexOf("Firefox") > -1, bCodeMirror: !!e}, a = function () {
        var t = function (t) {
            return function (e) {
                return t === e
            }
        ...
        return{head: t, last: e, initial: n, tail: o, sum: i, from: r, compact: s, clusterBy: l}
    }(), i = function () {
        var e = function (t) {
            return function (e) {
            ...
            var n = e.nextSibling, a = e.parentNode;
            return n ? a.insertBefore(t, n) : a.appendChild(t), t
        }, g = function (e, n) {
            return t.each(n, function (t, n) {
                e.appendChild(n)
            }), e
        }, p = e("#text"), y = function (t) {
        ...
        return{emptyPara: r, isText: p, isPara: n, isList: l, isEditable: s, isControlSizing: d, isAnchor: e("A"), isDiv: e("DIV"), isSpan: e("SPAN"), isB: e("B"), isU: e("U"), isS: e("S"), isI: e("I"), isImg: e("IMG"), isTextarea: e("TEXTAREA"), ancestor: c, listAncestor: u, listNext: v, listPrev: b, commonAncestor: f, listBetween: h, insertAfter: m, position: k, makeOffsetPath: w, fromOffsetPath: C, split: F, remove: S, html: A}
    }(), r = function () {
        var e = !!document.createRange, n = function (t, e) {
            var n, a, r = t.parentElement(), l = document.body.createTextRange(), s = o.from(r.childNodes);
            ...
            if (0 !== n && i.isText(s[n - 1])) {
                var d = document.body.createTextRange(), c = null;
            ...
            var e = function (t, n) {
                var r, l;
                if (i.isText(t)) {
                    var s = i.listPrev(t, a.not(i.isText)), d = o.last(s).previousSibling;
            ...
            }, n = document.body.createTextRange(), r = e(t.cont, t.offset);
            ...
            this.select = function () {
                ...
                var e = i.listBetween(n, s), r = o.compact(t.map(e, function (t) {
            ...
            this.isOnEditable = u(i.isEditable), this.isOnList = u(i.isList), this.isOnAnchor = u(i.isAnchor), this.isCollapsed = function () {
                ...
                return{s: {path: i.makeOffsetPath(t, n), offset: l}, e: {path: i.makeOffsetPath(t, s), offset: d}}
            }
        };
        return{create: function (t, a, o, i) {
            if (0 === arguments.length)if (e) {
                ...
                var d = document.selection.createRange(), c = d.duplicate();
                c.collapse(!1);
                var u = d;
                u.collapse(!0);
                var f = n(u, !0), h = n(c, !1);
            ...
            var n = i.fromOffsetPath(t, e.s.path), a = e.s.offset, o = i.fromOffsetPath(t, e.e.path), r = e.e.offset;
        ...
        this.stylePara = function (e, n) {
            ...
            var a = t(i.isText(e.sc) ? e.sc.parentNode : e.sc), o = a.css(["font-size", "text-align", "list-style-type", "line-height"]) || {};
            if (o["font-size"] = parseInt(o["font-size"]), o["font-bold"] = document.queryCommandState("bold") ? "bold" : "normal", o["font-italic"] = document.queryCommandState("italic") ? "italic" : "normal", o["font-underline"] = document.queryCommandState("underline") ? "underline" : "normal", e.isOnList()) {
                var r = ["circle", "disc", "disc-leading-zero", "square"], l = t.inArray(o["list-style-type"], r) > -1;
                o["list-style"] = l ? "unordered" : "ordered"
            } else o["list-style"] = "none";
            var s = i.ancestor(e.sc, i.isPara);
            if (s && s.style["line-height"])o["line-height"] = s.style.lineHeight; else {
        ...
        var t = [], e = [], n = function (t) {
            var e = t[0], n = r.create();
            return{contents: t.html(), bookmark: n.bookmark(e), scrollTop: t.scrollTop()}
        }, a = function (t, e) {
        ...
        this.currentStyle = function (t) {
            ...
            a(e);
            var n = r.create(), o = new Array(e.data("tabsize") + 1).join("&nbsp;");
        ...
        this.insertImage = function (e, n) {
            ...
            var a, o = /^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|\&v=)([^#\&\?]*).*/, i = n.match(o), l = /\/\/instagram.com\/p\/(.[a-zA-Z0-9]*)/, s = n.match(l), d = /\/\/vine.co\/v\/(.[a-zA-Z0-9]*)/, c = n.match(d), u = /\/\/(player.)?vimeo.com\/([a-z]*\/)*([0-9]{6,11})[?]?.*/, f = n.match(u), h = /.+dailymotion.com\/(video|hub)\/([^_]+)[^#]*(#video=([^_&]+))?/, b = n.match(h);
            if (i && 11 === i[2].length) {
                var v = i[2];
            ...
            o({range: l, text: l.toString(), url: l.isOnAnchor() ? i.ancestor(l.sc, i.isAnchor).href : ""}, function (o) {
                l.select(), a(e);
                var i;
            ...
            var n = JSON.parse(e), o = n.foreColor, i = n.backColor;
        ...
        this.update = function (e, n) {
            ...
            var o = t(e).closest(".note-color"), i = o.find(".note-recent-color"), r = JSON.parse(i.attr("data-value"));
        ...
        var e = function (e, n) {
            var a = t(n), o = a.position(), i = a.height();
            e.css({display: "block", left: o.left, top: o.top + i})
        };
        this.update = function (t, n) {
            var a = t.find(".note-link-popover"), o = t.find(".note-image-popover");
            if (n.anchor) {
                var i = a.find("a");
        ...
        this.update = function (e, n) {
            ...
            if (n.image) {
                var o = t(n.image), i = o.position(), r = {w: o.width(), h: o.height()};
                a.css({display: "block", left: i.left, top: i.top, width: r.w, height: r.h}).data("target", n.image);
                var l = r.w + "x" + r.h;
        ...
        this.showImageDialog = function (n, a, o) {
            var i = n.find(".note-image-dialog"), r = n.find(".note-image-input"), l = n.find(".note-image-url"), s = n.find(".note-image-btn");
            ...
            var o = t.find(".note-video-dialog"), i = o.find(".note-video-url"), r = o.find(".note-video-btn");
            ...
            var o = t.find(".note-link-dialog"), i = o.find(".note-link-text"), r = o.find(".note-link-url"), l = o.find(".note-link-btn");
            o.on("shown.bs.modal",function () {
        ...
        var a = new c, o = new u, r = new f, s = new h, d = new b, v = {BACKSPACE: 8, TAB: 9, ENTER: 13, SPACE: 32, NUM0: 48, NUM1: 49, NUM6: 54, NUM7: 55, NUM8: 56, B: 66, E: 69, I: 73, J: 74, K: 75, L: 76, R: 82, S: 83, U: 85, Y: 89, Z: 90, SLASH: 191, LEFTBRACKET: 219, BACKSLACH: 220, RIGHTBRACKET: 221}, m = function (e) {
            ...
            var e = n.bMac ? t.metaKey : t.ctrlKey, o = t.shiftKey, i = t.keyCode, r = e || o || i === v.TAB, l = r ? m(t.target) : null;
            if (i === v.TAB && l.editable().data("tabsize"))a.tab(l.editable()); else if (e && (o && i === v.Z || i === v.Y))a.redo(l.editable()); else if (e && i === v.Z)a.undo(l.editable()); else if (e && i === v.B)a.bold(l.editable()); else if (e && i === v.I)a.italic(l.editable()); else if (e && i === v.U)a.underline(l.editable()); else if (e && o && i === v.S)a.strikethrough(l.editable()); else if (e && i === v.BACKSLACH)a.removeFormat(l.editable()); else if (e && i === v.K)l.editable(), a.setLinkDialog(l.editable(), function (t, e) {
                d.showLinkDialog(l.dialog(), t, e)
            }); else if (e && i === v.SLASH)d.showHelpDialog(l.dialog()); else if (e && o && i === v.L)a.justifyLeft(l.editable()); else if (e && o && i === v.E)a.justifyCenter(l.editable()); else if (e && o && i === v.R)a.justifyRight(l.editable()); else if (e && o && i === v.J)a.justifyFull(l.editable()); else if (e && o && i === v.NUM7)a.insertUnorderedList(l.editable()); else if (e && o && i === v.NUM8)a.insertOrderedList(l.editable()); else if (e && i === v.LEFTBRACKET)a.outdent(l.editable()); else if (e && i === v.RIGHTBRACKET)a.indent(l.editable()); else if (e && i === v.NUM0)a.formatBlock(l.editable(), "P"); else if (e && v.NUM1 <= i && i <= v.NUM6) {
            ...
            var e = m(t.currentTarget || t.target), n = a.currentStyle(t.target);
            ...
            if (i.isControlSizing(e.target)) {
                var n, o = m(e.target), l = o.handle(), d = o.popover(), c = o.editable(), u = o.editor(), f = l.find(".note-control-selection").data("target"), h = t(f), b = h.offset(), v = t(document).scrollTop();
                u.on("mousemove",function (t) {
                    n = {x: t.clientX - b.left, y: t.clientY - (b.top - v)}, a.resizeTo(n, h), s.update(l, {image: f}), r.update(d, {image: f})
                }).on("mouseup", function () {
            ...
            if (l.length > 0) {
                var s, c = l.attr("data-event"), u = l.attr("data-value"), f = m(r.target), h = f.editor(), b = f.toolbar(), v = f.dialog(), g = f.editable(), y = f.codable();
                if (-1 !== t.inArray(c, ["resize", "floatMe"])) {
                    var k = f.handle(), C = k.find(".note-control-selection");
                    s = C.data("target")
                }
                if (a[c] && (g.trigger("focus"), a[c](g, u, s)), -1 !== t.inArray(c, ["backColor", "foreColor"]))o.updateRecentColor(l[0], c, u); else if ("showLinkDialog" === c)g.focus(), a.setLinkDialog(g, function (t, e) {
                ...
                }); else if ("showHelpDialog" === c)d.showHelpDialog(v); else if ("fullscreen" === c) {
                    h.toggleClass("fullscreen");
                    var x = function () {
                        var e = t(window).height() - b.outerHeight();
                        g.css("height", e)
                    }, F = h.hasClass("fullscreen");
                    if (F)g.data("orgHeight", g.css("height")), t(window).resize(x).trigger("resize"); else {
                    ...
                    if (A) {
                        if (y.val(g.html()), y.height(g.height()), o.disable(b), y.focus(), n.bCodeMirror) {
                            var E = e.fromTextArea(y[0], t.extend({mode: "text/html", lineNumbers: !0}, h.data("options").codemirror));
                            E.setSize(null, g.outerHeight()), E.autoFormatRange && E.autoFormatRange({line: 0, ch: 0}, {line: E.lineCount(), ch: E.getTextArea().value.length}), y.data("cmEditor", E)
                        }
            ...
            var n = t(document), a = m(e.target), o = a.editable(), i = o.offset().top - n.scrollTop(), r = function (t) {
            ...
            var n, a = t(e.target.parentNode), o = a.next(), i = a.find(".note-dimension-picker-mousecatcher"), r = a.find(".note-dimension-picker-highlighted"), l = a.find(".note-dimension-picker-unhighlighted");
            if (void 0 === e.offsetX) {
            ...
            r.css({width: d.c + "em", height: d.r + "em"}), i.attr("data-value", d.c + "x" + d.r), 3 < d.c && d.c < 10 && l.css({width: d.c + 1 + "em"}), 3 < d.r && d.r < 10 && l.css({height: d.r + 1 + "em"}), o.html(d.c + " x " + d.r)
        }, I = function (e) {
            var n = t(), a = e.dropzone, o = e.dropzone.find(".note-dropzone-message");
        ...
        this.attach = function (t, e) {
            ...
            var n = t.toolbar, o = n.find(".note-dimension-picker-mousecatcher");
            ...
            }), e.onfocus && t.editable.focus(e.onfocus), e.onblur && t.editable.blur(e.onblur), e.onkeyup && t.editable.keyup(e.onkeyup), e.onkeydown && t.editable.keydown(e.onkeydown), t.editable.data("callbacks", {onChange: e.onChange, onAutoSave: e.onAutoSave, onPasteBefore: e.onPasteBefore, onPasteAfter: e.onPasteAfter, onImageUpload: e.onImageUpload, onImageUploadError: e.onImageUpload, onFileUpload: e.onFileUpload, onFileUploadError: e.onFileUpload})
        }, this.dettach = function (t) {
            t.editable.off(), t.toolbar.off(), t.handle.off(), t.popover.off()
        }
    }, m = function () {
        var e, a, o, r, l;
        e = {picture: function (t) {
        ...
        var v = function (e, a) {
            e.find("button").each(function (e, a) {
                var o = t(a), i = o.attr(n.bMac ? "data-mac-shortcut" : "data-shortcut");
        ...
        this.createLayout = function (n, s) {
            var c = s.height, u = s.tabsize, f = s.toolbar, h = t.summernote.lang[s.lang];
        ...
        var p = this.layoutInfoFromHolder = function (t) {
            var e = t.next();
            if (e.hasClass("note-editor"))return{editor: e, dropzone: e.find(".note-dropzone"), toolbar: e.find(".note-toolbar"), editable: e.find(".note-editable"), codable: e.find(".note-codable"), statusbar: e.find(".note-statusbar"), popover: e.find(".note-popover"), handle: e.find(".note-handle"), dialog: e.find(".note-dialog")}
        };
    ...
    t.summernote = t.summernote || {}, t.extend(t.summernote, {version: "0.5.0", lang: {"en-US": {font: {bold: "Bold", italic: "Italic", underline: "Underline", strike: "Strike", clear: "Remove Font Style", height: "Line Height", size: "Font Size"}, image: {image: "Picture", insert: "Insert Image", resizeFull: "Resize Full", resizeHalf: "Resize Half", resizeQuarter: "Resize Quarter", floatLeft: "Float Left", floatRight: "Float Right", floatNone: "Float None", dragImageHere: "Drag an image here", selectFromFiles: "Select from files", url: "Image URL"}, link: {link: "Link", insert: "Insert Link", unlink: "Unlink", edit: "Edit", textToDisplay: "Text to display", url: "To what URL should this link go?"}, video: {video: "Video", videoLink: "Video Link", insert: "Insert Video", url: "Video URL?", providers: "(YouTube, Vimeo, Vine, Instagram, or DailyMotion)"}, table: {table: "Table"}, hr: {insert: "Insert Horizontal Rule"}, style: {style: "Style", normal: "Normal", blockquote: "Quote", pre: "Code", h1: "Header 1", h2: "Header 2", h3: "Header 3", h4: "Header 4", h5: "Header 5", h6: "Header 6"}, lists: {unordered: "Unordered list", ordered: "Ordered list"}, options: {help: "Help", fullscreen: "Full Screen", codeview: "Code View"}, paragraph: {paragraph: "Paragraph", outdent: "Outdent", indent: "Indent", left: "Align left", center: "Align center", right: "Align right", justify: "Justify full"}, color: {recent: "Recent Color", more: "More Color", background: "BackColor", foreground: "FontColor", transparent: "Transparent", setTransparent: "Set transparent", reset: "Reset", resetToDefault: "Reset to default"}, shortcut: {shortcuts: "Keyboard shortcuts", close: "Close", textFormatting: "Text formatting", action: "Action", paragraphFormatting: "Paragraph formatting", documentStyle: "Document Style"}, history: {undo: "Undo", redo: "Redo"}}}}), t.fn.extend({summernote: function (e) {
        if (e = t.extend({toolbar: [
            ...
            ["help", ["help"]]
        ], lang: "en-US"}, e), this.each(function (n, a) {
            var o = t(a);
            g.createLayout(o, e);
        ...
        this.each(function (e, n) {
            var a = t(n), o = g.layoutInfoFromHolder(a);
