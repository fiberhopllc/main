/* [ ---- Beoro Admin - dashboard ---- ] */
    ...
    $(document).ready(function() {
        //* todo list
        gobyweb_todoList.init();
        //* pageviews chart
        gobyweb_charts.pages();
        //* sales chart
        gobyweb_charts.sales();
        //* users chart
        gobyweb_charts.users();
        //* small gallery grid
        gobyweb_gal_grid.small();
        //* responsive carousel
        gobyweb_rcarousel.init();
        //* chat
        gobyweb_chat.init();
        //* calendar
        gobyweb_calendar.widget();
    });
    ...
    gobyweb_todoList = {
        init: function() {
            if($('.todo-list').length) {
                gobyweb_todoList.checkCompleted();
                gobyweb_todoList.completeTask();
                gobyweb_todoList.dragTasks();
                gobyweb_todoList.countTasks();
                gobyweb_todoList.countAll();
            }
        },
