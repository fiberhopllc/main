            ...
            $('#large_grid ul').imagesLoaded(function () {
                ...
                $('.remove_selected_img').click(function (e) {
                    ...
                    $('#large_grid ul li.checked_item').each(function () {
                        $(this).remove();
                        gobyweb_gal_grid.hide_item($(this).attr('id'));
                    })
                    refresh();
                })
                // remove single image
                $('.img_action_remove').on('click', function (e) {
                    ...
                    gobyweb_gal_grid.hide_item($(this).closest('li').attr('id'));
                    refresh();
                });
                // edit selected
                $('.edit_selected_img').click(function (e) {
                    ...
                    $('#large_grid ul li.checked_item').each(function () {
                        gobyweb_gal_grid.getEditInfo($(this).closest('li'));
                    });
                ...
                $('.close_edit_box').on('click', function () {
                    gobyweb_gal_grid.close_editBox();
                });
                function saveInfo() {
