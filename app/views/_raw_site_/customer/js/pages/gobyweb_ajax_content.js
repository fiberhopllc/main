        ...
        var updateContent = function (html) {
            ...
            if (data && "jnavlasttrigger" in data) {
                ...
                // help/faq content
                    ...
                    setTimeout(gobyweb_accordion.init,100);
                // datatables
                } else if ($trigger.hasClass("c_datatables")) {
                    // load stylesheet
                    if (document.createStyleSheet){
                        document.createStyleSheet('js/lib/datatables/css/datatables_gobyweb.css');
                    }
                    else {
                        $("head").append($("<link rel='stylesheet' href='js/lib/datatables/css/datatables_gobyweb.css' type='text/css' media='screen' />"));
                    }
                    // load scripts
