...
(function (c) {
    function q(a, d) {
        var j = !1;
        if ("string" === typeof d)return c.isFunction(a.test) ? a.test(d) : a == d;
        c.each(a, function (b) {
            if (void 0 === d[b])return j = !1;
            j = !0;
    ...
    function v(a, d) {
        if (c.isFunction(a))return a(d);
        if (c.isFunction(a.url.test)) {
            if (!a.url.test(d.url))return null
        } else {
            var j = a.url.indexOf("*");
            if (a.url !== d.url && -1 === j || !RegExp(a.url.replace(/[-[\]{}()+?.,\\^$|#\s]/g, "\\$&").replace("*", ".+")).test(d.url))return null
        }
        return a.data &&
    ...
    c.extend({ajax: function (a, d) {
        ...
        for (var p = 0; p < k.length; p++)if (k[p] &&
            (l = v(k[p], b))) {
            var f = b;
            if (window.console && console.log) {
                var g = "MOCK " + f.type.toUpperCase() + ": " + f.url, f = c.extend({}, f);
                if ("function" === typeof console.log)console.log(g, f); else try {
            ...
            if ("jsonp" === b.dataType) {
                a:{
                    var h = b, f = l, g = d, e = h;
                    if ("GET" === e.type.toUpperCase())m.test(e.url) || (e.url += (/\?/.test(e.url) ? "&" : "?") + (e.jsonp || "callback") + "=?"); else if (!e.data || !m.test(e.data))e.data = (e.data ? e.data + "&" : "") + (e.jsonp || "callback") + "=?";
                    h.dataType = "json";
                    if (h.data && m.test(h.data) || m.test(h.url))if (w(h, f), e = (e = /^(\w+:)?\/\/([^\/?#]+)/.exec(h.url)) && (e[1] && e[1] !== location.protocol || e[2] !== location.host), h.dataType = "script", "GET" === h.type.toUpperCase() && e) {
            ...
            if (!(!g.url instanceof RegExp) && g.hasOwnProperty("urlParams") && (h = g.url.exec(f.url), 1 !== h.length)) {
                ...
                for (e; e < n; e++)u[g.urlParams[e]] = h[e];
                f.urlParams = u
            }
            (function (a, d, e, f) {
                    ...
                    return{status: b.status, statusText: b.statusText, readyState: 1, open: function () {
                        ...
                        g = function () {
                            return function () {
                                ...
                                if ("json" == d.dataType && "object" == typeof a.responseText)this.responseText = JSON.stringify(a.responseText); else if ("xml" == d.dataType) {
                                    var b;
                                    if ("string" == typeof a.responseXML)a:{
                                        b =
                                            a.responseXML;
                                        ...
                                        try {
                                            ...
                                            if (c.isXMLDoc(f)) {
                                                if (1 == c("parsererror", f).length)throw"Error: " + c(f).text();
                                        ...
                                        a.responseXML;
                                    this.responseXML = b
                                } else this.responseText = a.responseText;
                        ...
                        if (b.headers && b.headers[a])return b.headers[a];
                        if ("last-modified" == a.toLowerCase())return b.lastModified || (new Date).toString();
                        if ("etag" == a.toLowerCase())return b.etag ||
                            "";
                        if ("content-type" == a.toLowerCase())return b.contentType || "text/plain"
