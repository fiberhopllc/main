...
(function ($) {
    function getDtNodeFromElement(a) {
        return alert("getDtNodeFromElement is deprecated"), $.ui.dynatree.getNode(a)
    }
    ...
    function _initDragAndDrop(a) {
        ...
        b && (b.onDragStart || b.onDrop) && _registerDnd(), b && b.onDragStart && a.$tree.draggable({addClasses: !1, appendTo: "body", containment: !1, delay: 0, distance: 4, revert: !1, scroll: !0, scrollSpeed: 7, scrollSensitivity: 10, connectToDynatree: !0, helper: function (a) {
            var b = $.ui.dynatree.getNode(a.target);
            return b ? b.tree._onDragEvent("helper", b, null, a, null, null) : "<div></div>"
        }, start: function (a, b) {
            var c = b.helper.data("dtSourceNode");
            return!!c
        }, _last: null}), b && b.onDrop && a.$tree.droppable({addClasses: !1, tolerance: "intersect", greedy: !1, _last: null})
    }
    ...
    DynaTreeNode.prototype = {initialize: function (a, b, c) {
        this.parent = a, this.tree = b, typeof c == "string" && (c = {title: c}), c.key === undefined && (c.key = "_" + b._nodeCount++), this.data = $.extend({}, $.ui.dynatree.nodedatadefaults, c), this.li = null, this.span = null, this.ul = null, this.childList = null, this._isLoading = !1, this.hasSubSel = !1, this.bExpanded = !1, this.bSelected = !1
    }, toString: function () {
        ...
        var a = this.tree, b = a.options, c = a.cache, d = this.getLevel(), e = this.data, f = "", g;
        d < b.minExpandLevel ? d > 1 && (f += c.tagConnector) : this.hasChildren() !== !1 ? f += c.tagExpander : f += c.tagConnector, b.checkbox && e.hideCheckbox !== !0 && !e.isStatusNode && (f += c.tagCheckbox), e.icon ? (e.icon.charAt(0) === "/" ? g = e.icon : g = b.imagePath + e.icon, f += "<img src='" + g + "' alt='' />") : e.icon !== !1 && (f += c.tagNodeIcon);
        var h = "";
        b.onCustomRender && (h = b.onCustomRender.call(a, this) || "");
        if (!h) {
            var i = e.tooltip ? ' title="' + e.tooltip.replace(/\"/g, "&quot;") + '"' : "", j = e.href || "#";
            b.noLink || e.noLink ? h = '<span style="display:inline-block;" class="' + b.classNames.title + '"' + i + ">" + e.title + "</span>" : h = '<a href="' + j + '" class="' + b.classNames.title + '"' + i + ">" + e.title + "</a>"
        }
        return f += h, f
    }, _fixOrder: function () {
        ...
        switch (a) {
            ...
            case DTNodeStatus_Loading:
                this._isLoading = !0, $(this.span).addClass(this.tree.options.classNames.nodeLoading), this.parent || this._setStatusNode({title: this.tree.options.strings.loading + d, tooltip: c, addClass: this.tree.options.classNames.nodeWait});
                break;
            case DTNodeStatus_Error:
                this._isLoading = !1, this._setStatusNode({title: this.tree.options.strings.loadError + d, tooltip: c, addClass: this.tree.options.classNames.nodeError});
                break;
            default:
        ...
        try {
            ...
            this.tree.logWarning("_loadContent: failed - %o", b), this.setLazyNodeStatus(DTNodeStatus_Error, {tooltip: "" + b})
        }
        ...
        var d = (!this.data.isLazy || this.childList !== null) && !this._isLoading && !b;
        this.render(d);
        ...
        if (a && this.data.isLazy && this.childList === null && !this._isLoading) {
            this._loadContent();
            return
        }
        ...
        if (b === "expander")this.toggleExpand(), this.focus(); else if (b === "checkbox")this.toggleSelect(), this.focus(); else {
            ...
            if (c[0])$.browser.msie && parseInt($.browser.version, 10) < 9 || c[0].focus(); else return!0
        }
        a.preventDefault()
        ...
        if (d) {
            for (var e = 0, f = d.length; e < f; e++) {
                var g = d[e];
                g === c.activeNode && !b && g.deactivate(), this.tree.options.persist && !b && (g.bSelected && this.tree.persistence.clearSelect(g.data.key), g.bExpanded && this.tree.persistence.clearExpand(g.data.key)), g.removeChildren(!0, b), this.ul && $("li", $(this.ul)).remove()
            }
            this.childList = null
        }
        a || (this._isLoading = !1, this.render())
    }, setTitle: function (a) {
        this.fromDict({title: a})
    }, reload: function (a) {
        ...
        var e = d.shift();
        if (this.childList)for (var f = 0, g = this.childList.length; f < g; f++) {
        ...
        b.call(c, undefined, "notfound", e, d.length === 0), c.logWarning("Node not found: " + e);
        return
    }, resetLazy: function () {
        if (this.parent === null)throw"Use tree.reload() instead";
        ...
        var d = a.success, e = a.error, f = "nodeLoaded.dynatree." + this.tree.$tree.attr("id") + "." + this.data.key, g = $.extend({}, this.tree.options.ajaxDefaults, a, {success: function (a, c, e) {
            var h = b.tree.phase;
            b.tree.phase = "init", g.postProcess ? a = g.postProcess.call(this, a, this.dataType) : a && a.hasOwnProperty("d") && (a = typeof a.d == "string" ? $.parseJSON(a.d) : a.d), (!$.isArray(a) || a.length !== 0) && b.addChild(a, null), b.tree.phase = "postInit", d && d.call(g, b, a, c), b.tree.logDebug("trigger " + f), b.tree.$tree.trigger(f, [b, !0]), b.tree.phase = h, b.setLazyNodeStatus(DTNodeStatus_Ok), $.isArray(a) && a.length === 0 && (b.childList = [], b.render())
        }, error: function (a, c, d) {
            b.tree.logWarning("appendAjax failed:", c, ":\n", a, "\n", d), e && e.call(g, b, a, c, d), b.tree.$tree.trigger(f, [b, !1]), b.setLazyNodeStatus(DTNodeStatus_Error, {info: c, tooltip: "" + d})
        }});
        $.ajax(g)
    }, move: function (a, b) {
        var c;
        ...
        this.parent.ul && this.parent.ul.removeChild(this.li), this.parent = e;
        ...
        e.ul || (e.ul = document.createElement("ul"), e.ul.style.display = "none", e.li.appendChild(e.ul)), this.li && e.ul.appendChild(this.li);
    ...
    }, getDynaTreePersistData = DynaTreeStatus._getTreePersistData, DynaTreeStatus.prototype = {initialize: function (a, b) {
    ...
    DynaTree.version = "$Version:$", DynaTree.prototype = {initialize: function (a) {
        ...
        for (var e = 0, f = b.length; e < f; e++)d.push({name: c, value: b[e].data.key});
        return d
        ...
        if (d === "after" || d === "before" || d === "over") {
            ...
            switch (d) {
                case"before":
                    this.$dndMarker.removeClass("dynatree-drop-after dynatree-drop-over"), this.$dndMarker.addClass("dynatree-drop-before"), h = "0 -8";
                    break;
                case"after":
                    this.$dndMarker.removeClass("dynatree-drop-before dynatree-drop-over"), this.$dndMarker.addClass("dynatree-drop-after"), h = "0 8";
                    break;
                default:
                    this.$dndMarker.removeClass("dynatree-drop-after dynatree-drop-before"), this.$dndMarker.addClass("dynatree-drop-over"), g.addClass("dynatree-drop-target"), h = "8 0"
            }
            this.$dndMarker.show().position({my: "left top", at: "left top", of: g, offset: h})
        ...
        var g = this.options, h = this.options.dnd, i = null, j = $(b.span), k, l;
        switch (a) {
            case"helper":
                var m = $("<div class='dynatree-drag-helper'><span class='dynatree-drag-helper-img' /></div>").append($(d.target).closest("a").clone());
                $("ul.dynatree-container", b.tree.divTree).append(m), m.data("dtSourceNode", b), i = m;
                break;
            case"start":
                ...
                break;
            case"enter":
                i = h.onDragEnter ? h.onDragEnter(b, c) : null, i ? i = {over: i === !0 || i === "over" || $.inArray("over", i) >= 0, before: i === !0 || i === "before" || $.inArray("before", i) >= 0, after: i === !0 || i === "after" || $.inArray("after", i) >= 0} : i = !1, e.helper.data("enterResponse", i);
                break;
            case"over":
                l = e.helper.data("enterResponse"), k = null;
                if (l !== !1)if (typeof l == "string")k = l; else {
                    var n = j.offset(), o = {x: d.pageX - n.left, y: d.pageY - n.top}, p = {x: o.x / j.width(), y: o.y / j.height()};
                    l.after && p.y > .75 ? k = "after" : !l.over && l.after && p.y > .5 ? k = "after" : l.before && p.y <= .25 ? k = "before" : !l.over && l.before && p.y <= .5 ? k = "before" : l.over && (k = "over"), h.preventVoidMoves && (b === c ? k = null : k === "before" && c && b === c.getNextSibling() ? k = null : k === "after" && c && b === c.getPrevSibling() ? k = null : k === "over" && c && c.parent === b && c.isLastSibling() && (k = null)), e.helper.data("hitMode", k)
                }
                k === "over" && h.autoExpandMS && b.hasChildren() !== !1 && !b.bExpanded && b.scheduleAction("expand", h.autoExpandMS);
                if (k && h.onDragOver) {
                    i = h.onDragOver(b, c, k);
                    if (i === "over" || i === "before" || i === "after")k = i
                }
                this._setDndStatus(c, b, e.helper, k, i !== !1 && k !== null);
                break;
            case"drop":
                var q = e.helper.hasClass("dynatree-drop-reject");
                k = e.helper.data("hitMode"), k && h.onDrop && !q && h.onDrop(b, c, k, e, f);
                break;
            case"leave":
    ...
    }, lastentry: undefined}), parseFloat($.ui.version) < 1.8 && ($.ui.dynatree.getter = "getTree getRoot getActiveNode getSelectedNodes"), $.ui.dynatree.version = "$Version:$", $.ui.dynatree.getNode = function (a) {
        if (a instanceof DynaTreeNode)return a;
        a.selector !== undefined && (a = a[0]);
        while (a) {
    ...
    var didRegisterDnd = !1, _registerDnd = function () {
        ...
        $.ui.plugin.add("draggable", "connectToDynatree", {start: function (a, b) {
            ...
            var c = $(this).data("draggable"), d = b.helper.data("dtSourceNode") || null, e = b.helper.data("dtTargetNode") || null, f = $.ui.dynatree.getNode(a.target);
            if (a.target && !f) {
                var g = $(a.target).closest("div.dynatree-drag-helper,#dynatree-drop-marker").length > 0;
                if (g)return
            }
            b.helper.data("dtTargetNode", f), e && e !== f && e.tree._onDragEvent("leave", e, d, a, b, c), f && (!f.tree.options.dnd.onDrop || (f === e ? f.tree._onDragEvent("over", f, d, a, b, c) : f.tree._onDragEvent("enter", f, d, a, b, c)))
        }, stop: function (a, b) {
