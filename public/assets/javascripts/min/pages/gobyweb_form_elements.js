...
$(document).ready(function () {
    //* one page navigation
    gobyweb_PageNav.init();
    //* ui sliders
    gobyweb_sliders.init();
    //* ui progressbars
    gobyweb_progressbars.init();
    //* 2col multiselect
    gobyweb_multiselect.init();
    //* enchanced select box
    gobyweb_enchancedSelect.init();
    //* masked inputs
    gobyweb_maskedInputs.init();
    //* password strength meter
    gobyweb_password_meter.init();
    //* datepicker
    gobyweb_datepicker.init();
    //* timepicker
    gobyweb_timepicker.init();
    //* colorpicker
    gobyweb_colorpicker.init();
    //* switch buttons
    gobyweb_switchButtons.init();
    //* autosize textarea
    gobyweb_autosize_textarea.init();
    //* textarea counter
    gobyweb_textarea_counter.init();
    // UI spinners
    gobyweb_uiSpinners.init();
    //* multiupload
    gobyweb_multiupload.init();
    //* WYSIWG Editor
    gobyweb_wysiwg.init();
});
...
//* progressbars
gobyweb_progressbars = {
    init: function () {
        gobyweb_progressbars.start();
    },
    start: function () {
        if ($('#progress1').length) {
...
gobyweb_maskedInputs = {
    init: function () {
        ...
        $("#mask_callback").inputmask("d/m/y", { "placeholder": "dd/mm/yyyy", "oncomplete": function () {
