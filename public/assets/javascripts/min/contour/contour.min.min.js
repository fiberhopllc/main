...
var b={xAxis:{type:"linear"},scatter:{radius:4}};a.defaults=b,Contour.export("scatter",a)}(),function(){Contour.export("stackTooltip",function(a,b,c){var d=this.yAxis().tickFormat(),e=d3.select(c.stackTooltip.el);e.classed("stack-tooltip",!0);var f=function(b){var f=function(a){return!(a&&null!=a.y)},g=function(a,d){var e=_.isNumber(b.x)?b.x:c.xAxis.categories.indexOf(b.x);return f(a.data[e])?null:{seriesName:a.name,value:a.data[e].y,cssClass:"s-"+(d+1)}},h=_.filter(_.map(a,g),function(a){return a}),i=_.map(h,function(a){return'<span class="'+a.cssClass+'"">'+a.seriesName+": "+d(a.value)+"</span>"}).join(" / ");e.html(i).style({display:"block"})},g=function(){e.html("")};this.svg.selectAll(".tooltip-tracker").on("mouseover.tooltip",f.bind(this)).on("mouseout.tooltip",g.bind(this))})}(),function(){function a(a,b,c){function d(b){var c=[];return _.each(a,function(a){var d=a.name;_.each(a.data,function(a){a.x===b.x&&b.y===a.y&&c.push({x:a.x,y:a.y,series:d})})}),c}
var e=function(){clearTimeout(this.tooltip.hideTimer)},f=function(a,b){this.options.tooltip.animate?this.tooltipElement.transition().duration(b).style("opacity",a):this.tooltipElement.style("opacity",a)},g=function(a){var b=a.getBoundingClientRect();return a.getBoundingClientRect(),[b.left+b.width/2,b.top+b.height/2]},h=function(a){var b,d=function(){return"path"===d3.event.target.tagName?g(d3.event.target):d3.mouse(this.container.node())},e=this.xScale,f=this.yScale,h=this.options.chart.plotLeft,i=this.options.chart.plotWidth,j=this.options.chart.plotTop,k=this.options.chart.plotHeight,l=this.options.tooltip.distance,m=parseFloat(this.tooltipElement.style("width")),n=parseFloat(this.tooltipElement.style("height")),o=e?e(a.x):d()[0],p=f?f(a.y):d()[1],q=function(a){return a.x<h&&(a.x=h+l),a.x+m>h+i&&(a.x-=a.x+m-(h+i),a.y=j+p-(n+l),b=!0),a.y<j&&(a.y=j+l,b&&p>=a.y&&p<=a.y+n&&(a.y=p+j+l)),a.y+n>j+k&&(a.y=Math.max(j,j+k-(n+l))),a},r={vertical:function(){var a={x:h+o-(l+m),y:j+p-(l+n)};return q(a)},horizontal:function(){var a={x:h+p-(l+m),y:j+o-(l+n)};return q(a)}};return c.chart.rotatedFrame?r.horizontal():r.vertical()},i=function(a){l.call(this,a)},j=function(){f.call(this,0,this.options.tooltip.hideTime)},k=function(a,b){function c(){var a=Array.prototype.slice.call(arguments),b=a[0],c=a.slice(1),d=_.map(b,function(a){return a.apply(this,c)}).concat([_.noop]);return _.first(_.select(d))}
var d=this.options.tooltip,e=[function(a){return d.formatter?_.partial(d.formatter,a,b):null},function(a){return a.hasOwnProperty("x")?_.partial(function(a){return a.series+"<br>"+a.x+"<br>"+a.y},a):null},function(a){return a.data&&a.data.hasOwnProperty("x")?_.partial(function(a){return a.series+"<br>"+a.x+"<br>"+a.y},a.data):null},function(a){return a.hasOwnProperty("value")?_.partial(function(a){return a.value},a):null},function(){return function(){return"NA"}}];return c(e,a)()},l=function(a){e.call(this),dataPoints=d(a),this.tooltipElement.select(".text").html(k.call(this,dataPoints[0],dataPoints));var b=h.call(this,a);this.tooltipElement.style("top",b.y+"px").style("left",b.x+"px"),f.call(this,this.options.tooltip.opacity,this.options.tooltip.showTime)};this.tooltipElement=this.container.style("position","relative").selectAll(".nw-tooltip").data([1]),this.tooltipElement.enter().append("div").attr("class","nw-tooltip").style("opacity",0).append("div").attr("class","text"),this.svg.selectAll(".tooltip-tracker").on("mouseover.tooltip",i.bind(this)).on("mouseout.tooltip",j.bind(this))}
var b={tooltip:{enable:!0,animate:!0,opacity:.85,showTime:300,hideTime:500,distance:5}};a.defaults=b,Contour.export("tooltip",a)}(),function(){function a(a,b,c){this.checkDependencies("cartesian");var d=null!=c.chart.animations.duration?c.chart.animations.duration:400,e=c.chart.animations&&c.chart.animations.enable,f=_.bind(function(a){return this.xScale(a)+this.rangeBand/2},this),g=_.bind(function(a){return this.yScale(a)},this),h=_.nw.linearRegression(_.flatten(_.pluck(a,"data"))),i=d3.extent(this.xScale.domain()),j=function(a){return h.intercept+h.slope*a},k=b.selectAll(".trend-line").data([1]);k.enter().append("line").attr("class","trend-line").attr("x1",f(i[0])).attr("y1",g(j(i[0]))).attr("x2",f(i[0])).attr("y2",g(j(i[0]))),k.exit().remove(),e?k.transition().duration(d).attr("x1",f(i[0])).attr("y1",g(j(i[0]))).attr("x2",f(i[1])).attr("y2",g(j(i[1]))):k.attr("x1",f(i[0])).attr("y1",g(j(i[0]))).attr("x2",f(i[1])).attr("y2",g(j(i[1])))}
a.defaults={},Contour.export("trendLine",a)}(),"object"==typeof module&&module&&"object"==typeof module.exports?module.exports=Contour:(b.Contour=Contour,"function"==typeof define&&define.amd&&define("contour",[],function(){return Contour}))}();