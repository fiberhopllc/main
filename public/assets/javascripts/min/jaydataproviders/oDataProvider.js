...
$data.oDataConverter = {
    fromDb: {
        ...
        '$data.Blob': function (v) {
            if (typeof v == 'string') {
                try {
                    return $data.Container.convertTo(atob(v), '$data.Blob');
                }
                catch (e) {
                    return v;
                }
        ...
        '$data.GeographyPoint': function (g) {
            if (g) {
                return new $data.GeographyPoint(g);
            }
            return g;
        },
        '$data.GeographyLineString': function (g) {
            if (g) {
                return new $data.GeographyLineString(g);
            }
            return g;
        },
        '$data.GeographyPolygon': function (g) {
            if (g) {
                return new $data.GeographyPolygon(g);
            }
            return g;
        },
        '$data.GeographyMultiPoint': function (g) {
            if (g) {
                return new $data.GeographyMultiPoint(g);
            }
            return g;
        },
        '$data.GeographyMultiLineString': function (g) {
            if (g) {
                return new $data.GeographyMultiLineString(g);
            }
            return g;
        },
        '$data.GeographyMultiPolygon': function (g) {
            if (g) {
                return new $data.GeographyMultiPolygon(g);
            }
            return g;
        },
        '$data.GeographyCollection': function (g) {
            if (g) {
                return new $data.GeographyCollection(g);
            }
            return g;
        },
        '$data.GeometryPoint': function (g) {
            if (g) {
                return new $data.GeometryPoint(g);
            }
            return g;
        },
        '$data.GeometryLineString': function (g) {
            if (g) {
                return new $data.GeometryLineString(g);
            }
            return g;
        },
        '$data.GeometryPolygon': function (g) {
            if (g) {
                return new $data.GeometryPolygon(g);
            }
            return g;
        },
        '$data.GeometryMultiPoint': function (g) {
            if (g) {
                return new $data.GeometryMultiPoint(g);
            }
            return g;
        },
        '$data.GeometryMultiLineString': function (g) {
            if (g) {
                return new $data.GeometryMultiLineString(g);
            }
            return g;
        },
        '$data.GeometryMultiPolygon': function (g) {
            if (g) {
                return new $data.GeometryMultiPolygon(g);
            }
            return g;
        },
        '$data.GeometryCollection': function (g) {
            if (g) {
                return new $data.GeometryCollection(g);
            }
            return g;
        },
        '$data.Guid': function (guid) {
    ...
    toDb: {
        ...
        '$data.Boolean': $data.Container.proxyConverter,
        '$data.Blob': function (v) {
            return v ? $data.Blob.toBase64(v) : v;
        },
    ...
    escape: {
        ...
        '$data.DateTimeOffset': function (date) {
        ...
        '$data.ObjectID': function (text) {
            return typeof text === 'string' ? "'" + text.replace(/'/g, "''") + "'" : text;
        },
        '$data.Boolean': function (bool) {
            return typeof bool === 'boolean' ? bool.toString() : bool;
        },
        '$data.Blob': function (b) {
            return b ? "X'" + $data.Blob.toHexString($data.Container.convertTo(atob(b), $data.Blob)) + "'" : b;
        },
        '$data.Object': function (o) {
        ...
        '$data.GeographyPoint': function (g) {
            if (g) {
                return $data.GeographyBase.stringifyToUrl(g);
            }
            return g;
        },
        '$data.GeographyLineString': function (g) {
        ...
        '$data.GeometryPoint': function (g) {
            if (g) {
                return $data.GeometryBase.stringifyToUrl(g);
            }
            return g;
        },
        '$data.GeometryLineString': function (g) {
    ...
    unescape: {
        ...
        '$data.Number': function (v) {
            return JSON.parse(v);
        },
        '$data.Integer': function (v) {
            return JSON.parse(v);
        },
        '$data.Int32': function (v) {
            return JSON.parse(v);
        },
        '$data.Byte': function (v) {
            return JSON.parse(v);
        },
        '$data.SByte': function (v) {
            return JSON.parse(v);
        },
        '$data.Decimal': function (v) {
    ...
    simple: { //$value, $count
        ...
        '$data.Date': function (o) {
            return o instanceof $data.Date ? o.toISOString().replace('Z', '') : o.toString()
        },
        '$data.DateTimeOffset': function (v) {
            return v ? v.toISOString() : v;
        },
        '$data.Time': function (o) {
            return o.toString();
        },
        ...
        '$data.GeographyLineString': function (o) {
            return JSON.stringify(o);
        },
        '$data.GeographyPolygon': function (o) {
            return JSON.stringify(o);
        },
        '$data.GeographyMultiPoint': function (o) {
            return JSON.stringify(o);
        },
        '$data.GeographyMultiLineString': function (o) {
            return JSON.stringify(o);
        },
        '$data.GeographyMultiPolygon': function (o) {
            return JSON.stringify(o);
        },
        '$data.GeographyCollection': function (o) {
            return JSON.stringify(o);
        },
        '$data.GeometryLineString': function (o) {
            return JSON.stringify(o);
        },
        '$data.GeometryPolygon': function (o) {
            return JSON.stringify(o);
        },
        '$data.GeometryMultiPoint': function (o) {
            return JSON.stringify(o);
        },
        '$data.GeometryMultiLineString': function (o) {
            return JSON.stringify(o);
        },
        '$data.GeometryMultiPolygon': function (o) {
            return JSON.stringify(o);
        },
        '$data.GeometryCollection': function (o) {
            return JSON.stringify(o);
        }
    }
};
...
$C('$data.storageProviders.oData.oDataProvider', $data.StorageProviderBase, null,
    {
                                ...
                                if (refValue instanceof $data.Array) {
                                    ...
                                    refValue.forEach(function (rv) {
                                        if (rv.entityState == $data.EntityState.Modified || convertedItems.indexOf(rv) < 0) {
                                            ...
                                            if (contentId < 0) {
                                                Guard.raise("Dependency graph error");
                                            }
        ...
        buildDbType_modifyInstanceDefinition: function () {
            return;
        },
        executeQuery: function (query, callBack) {
            ...
            var requestData = [
                ...
                function (data, textStatus, jqXHR) {
                    ...
                    if (callBack.success) {
                        query.rawDataList = typeof data === 'string' ? [
                            { cnt: Container.convertTo(data, $data.Integer) }
                        ] : data;
                    ...
                    if (response.statusCode == 204) {
                        if (response.headers.ETag || response.headers.Etag || response.headers.etag) {
                            var property = item.getType().memberDefinitions.getPublicMappedProperties().filter(function (memDef) {
                                return memDef.concurrencyMode === $data.ConcurrencyMode.Fixed
                            });
        ...
        save_getInitData: function (item, convertedItems) {
            ...
            item.physicalData.getType().memberDefinitions.asArray().forEach(function (memdef) {
                if (memdef.kind == $data.MemberTypes.navProperty || memdef.kind == $data.MemberTypes.complexProperty || (memdef.kind == $data.MemberTypes.property && !memdef.notMapped)) {
                    if (typeof memdef.concurrencyMode === 'undefined' && (memdef.key === true || item.data.entityState === $data.EntityState.Added || item.data.changedProperties.some(function (def) {
            ...
            value: {
                ...
                length: [
                    ...
                    },
                    {
                        ...
                        parameters: [
                            { name: "@expression", dataType: ['GeographyLineString'] }
                        ],
                    ...
                    },
                    {
                        ...
                        dataType: "number", allowedIn: [$data.Expressions.FilterExpression, $data.Expressions.OrderExpression],
                        parameters: [
                            { name: "@expression", dataType: 'GeometryLineString' }
                        ],
                        fixedDataType: 'decimal'
                    }
                ],
                ...
                replace: {
                    ...
                    parameters: [
                        { name: '@expression', dataType: "string" },
                        { name: 'strFrom', dataType: 'string' },
                        { name: 'strTo', dataType: 'string' }
                    ]
                },
                ...
                distance: [
                    {
                        ...
                        dataType: "number", allowedIn: [$data.Expressions.FilterExpression, $data.Expressions.OrderExpression],
                        parameters: [
                            { name: "@expression", dataType: 'GeographyPoint' },
                            { name: "to", dataType: 'GeographyPoint' }
                        ],
                        fixedDataType: 'decimal'
                    },
                    {
                        ...
                        dataType: "number", allowedIn: [$data.Expressions.FilterExpression, $data.Expressions.OrderExpression],
                        parameters: [
                            { name: "@expression", dataType: 'GeometryPoint' },
                            { name: "to", dataType: 'GeometryPoint' }
                        ],
                        fixedDataType: 'decimal'
                    }
                ],
                ...
                intersects: [
                    {
                        ...
                        parameters: [
                            { name: "@expression", dataType: 'GeographyPoint' },
                            { name: "in", dataType: 'GeographyPolygon' }
                        ]
                    ...
                    },
                    {
                        ...
                        parameters: [
                            { name: "@expression", dataType: 'GeometryPoint' },
                            { name: "in", dataType: 'GeometryPolygon' }
                        ]
        ...
        resolveTypeOperations: function (operation, expression, frameType) {
            ...
            if (!memDef || !memDef.method ||
                memDef.method.IsSideEffecting !== false || !memDef.method.returnType || !(frameType === $data.Expressions.FilterExpression || frameType === $data.Expressions.OrderExpression)) {
...
$C('$data.storageProviders.oData.oDataWhereCompiler', $data.Expressions.EntityExpressionVisitor, null, {
    ...
    VisitSimpleBinaryExpression: function (expression, context) {
        ...
        if (expression.nodeType == "in") {
            ...
            if (!paramValue instanceof Array) {
                Guard.raise(new Exception("Right to the 'in' operator must be an array value"));
            }
            var result = null;
    ...
    VisitEntityFunctionOperationExpression: function (expression, context) {
        ...
        context.data += "(";
        var paramCounter = 0;
        var params = opDef.method.params || [
            { name: "@expression" }
        ];
    ...
    VisitPagingExpression: function (expression, context) {
        ...
        switch (expression.nodeType) {
            case $data.Expressions.ExpressionType.Skip:
                context['$skip'] = pagingContext.data;
                break;
            case $data.Expressions.ExpressionType.Take:
                context['$top'] = pagingContext.data;
                break;
            default:
                Guard.raise("Not supported nodeType");
                break;
        }
    },
    VisitConstantExpression: function (expression, context) {
